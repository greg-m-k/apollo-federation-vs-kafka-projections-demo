 ...
 * Captures actual measured times for each operation (db_write, outbox_write, etc.).
 */
@RequestScoped
public class TimingContext {
    ...
    public long measureOperation(String operation, Runnable task) {
